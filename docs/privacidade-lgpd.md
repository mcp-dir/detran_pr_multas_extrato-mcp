...
DETRAN PR: Multas (Extrato) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [detran_pr_multas_extrato@mcp.ai](mailto:detran_pr_multas_extrato@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
